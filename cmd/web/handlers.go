...
import (
	...
	"github.com/Michael-Wilburn/snippetbox/internal/validator"
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// Call the Decode() method of the form decoder, passing in the current content
	// request and *a pointer* to ur snippetCreateForm struct. This will
	// essentially fill our struct with the relevant values from HTML form.
	...
	// the first line here we "check that the form.Title field has a maximum character
