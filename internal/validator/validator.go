...
// for sanity checking the format of an email addres. This returns a pointer to
// a 'compiled' regexp.Regexp type, or panics in the event of and error. Parsing
// this pattern once at startup and storing the compiled *regexp.Regexp in a
// variable is more performant than re-parsing the patter each time we need it.
...
// hold any validation errors which are not related to a secific form field.
...
// Update the Valid() method to also check the NonFieldErrors slice is empty.
...
// Replace PermiteddInt() with a generic PermittedValue() function. This returns
